        ...
        <div>
            ...
            <Container containerclass="container p-4 mt-3 mb-4">
                ...
                <Row>
                       ...
                       <Col><Project image={weatherImage} title="Weather Dashboard" grey={greyProject(['css','javascript', 'html', 'JQuery'])}deployedlink="https://cazb67.github.io/weather-dashboard/" githublink="https://github.com/CazB67/weather-dashboard" description ="A weather dashboard that runs in the browser and features dynamically updated HTML and uses the Open Weather API."/></Col> 
                </Row>
                <Row>
                       <Col><Project image={burgerImage} grey={greyProject(['css','javascript', 'html', 'mysql', 'nodejs', 'JQuery', 'handlebars'])} title="Burger App" deployedlink="https://blooming-chamber-66556.herokuapp.com/" githublink="https://github.com/CazB67/burger" description="A burger logger app using MySQL, Node, Express, Handlebars and an ORM that follows the the MVC design pattern and CRUD routes"/></Col>
                       <Col><Project image={codeImage}title="Code Quiz" grey={greyProject(['css','javascript', 'html'])} deployedlink="https://cazb67.github.io/code-quiz/" githublink="https://github.com/CazB67/code-quiz"  description="A timed code quiz with multiple-choice questions using Javascript and Bootstrap, that saves scores to local storage."/></Col> 
                       <Col><Project image={directoryImage} title="Employee Directory" grey={greyProject(['css','javascript', 'html','react'])}deployedlink="https://mighty-sierra-02848.herokuapp.com/" githublink="https://github.com/CazB67/employee-directory" description ="A react app that sorts employees according to firstname and filters employees on input"/></Col> 
                </Row>
            </Container>
